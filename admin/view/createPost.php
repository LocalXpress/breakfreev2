...
<body>
  ...
  <form action="index.php" method="post" enctype="multipart/form-data">
    ...
    <input type="file" name="headerImage"   id="headerImage"    placeholder="Header Image of the article" required/><br><br>
    ...
    <input type="text" name="summary"       id="summary"        placeholder="Summary of the Article"      required /><br>
    Catagory: 
